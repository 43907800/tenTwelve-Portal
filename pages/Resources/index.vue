        ...
        <ul class="activity">
          <li class="activity-item">
            <div class="activity-inner">
              <a href="http://"></a>
              <div class="img">
                <a href="~/assets/activity-detail.html" target="_blank">
          ...
          <li class="activity-item">
            <div class="activity-inner">
              ...
              <div class="img">
                <a href="~/assets/activity-detail.html" target="_blank">
                  <img src="~/assets/img/widget-activity2.png" alt />
                </a>
              </div>
              <div class="text">
                <p class="title">APMCon2017中国应用性能管理大会</p>
          ...
          <li class="activity-item">
            <div class="activity-inner">
              ...
              <div class="img">
                <a href="~/assets/activity-detail.html" target="_blank">
                  <img src="~/assets/img/widget-activity3.png" alt />
                </a>
              </div>
              <div class="text">
                <p class="title">APMCon2017中国应用性能管理大会</p>
          ...
          <li class="activity-item">
            <div class="activity-inner">
              ...
              <div class="img">
                <a href="~/assets/activity-detail.html" target="_blank">
                  <img src="~/assets/img/widget-activity5.png" alt />
                </a>
              </div>
              <div class="text">
                <p class="title">APMCon2017中国应用性能管理大会</p>
          ...
          <li class="activity-item">
            <div class="activity-inner">
              ...
              <div class="img">
                <a href="~/assets/activity-detail.html" target="_blank">
                  <img src="~/assets/img/widget-activity4.png" alt />
                </a>
              </div>
              <div class="text">
                <p class="title">APMCon2017中国应用性能管理大会</p>
